<div dir="rtl">
<h1>مشروع تطبيق للقرآن الكريم  للهواتف الذكية مبني بلغات الويب</h1>
...
<h2>الجوانب التقنية</h2>
المشروع مبني على إطار العمل [Ionic](http://ionicframework.com/) الذي يستخدم Angular JS، النصوص البرمجية مكتوبة بلغة [CoffeeScript](http://coffeescript.org/) وملفات العرض مكتوبة بلغة [Jade](http://jade-lang.com)، ملفات التنسيق مكتوبة بلغة [Sass](http://sass-lang.com).
...
<h2>ما الأنظمة التي سيستهدفها المشروع؟</h2>
...
<h2>تجربة المشروع والمساهمة في التطوير</h2>
